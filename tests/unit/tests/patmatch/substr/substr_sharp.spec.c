...
{																	\
	...
	char		*actual = substr_sharp(tmp, string, pattern);		\
	if (debug)														\
	{																\
		printf("=== case: %s - %s\n", string, pattern);				\
		printf("actual    {%s}\n", actual);							\
