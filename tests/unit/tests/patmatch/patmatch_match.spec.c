...
static void	test_simple_question_mark(t_test *test)
{
	...
	PATMATCH_NULL("/tmp/sandbox/test?", 3);
}
...
static void	test_simple_bracket(t_test *test)
{
	...
	PATMATCH_NULL("/tmp/sandbox/test[0123]", 3);
	...
	PATMATCH_NULL("/tmp/sandbox/test[0-3]", 3);
	...
	PATMATCH_NULL("/tmp/sandbox/test[[:digit:]]", 3);
	...
	PATMATCH_NULL("/tmp/sandbox/test[^a-zA-Z]", 3);
}
...
static void	test_middle_bracket(t_test *test)
{
	...
	PATMATCH_NULL("/tmp/sandbox/[aze][AZE][123]", 1);
	PATMATCH_TEST("/tmp/sandbox/[a-z][A-Z][0-9]", 0, "/tmp/sandbox/aZ1");
	PATMATCH_NULL("/tmp/sandbox/[a-z][A-Z][0-9]", 1);
	PATMATCH_TEST("/tmp/sandbox/[[:lower:]][[:upper:]][[:digit:]]", 0, "/tmp/sandbox/aZ1");
	PATMATCH_NULL("/tmp/sandbox/[[:lower:]][[:upper:]][[:digit:]]", 1);
	...
	PATMATCH_NULL("/tmp/sandbox/[aze[:lower:]a-z-][[:upper:]][[:digit:]]", 2);
	PATMATCH_TEST("/tmp/sandbox/[^ze[:digit:]z-a-][^[:upper:]][^[:digit:]]", 0, "/tmp/sandbox/Z1a");
	PATMATCH_TEST("/tmp/sandbox/[^ze[:digit:]z-a-][^[:upper:]][^[:digit:]]", 1, "/tmp/sandbox/a1Z");
	PATMATCH_NULL("/tmp/sandbox/[^ze[:digit:]z-a-][^[:upper:]][^[:digit:]]", 2);
...
static void	test_melting_pot(t_test *test)
{
	...
	PATMATCH_NULL("/tmp/sandbox/*[[:digit:]]/???*[^[:digit:]]", 1);
	PATMATCH_TEST("/tmp/sandbox/*?[[:lower:]]?[[:digit:]]*/*?[[:lower:]]?[[:digit:]]*/**?**?**?**?**", 0, "/tmp/sandbox/test0/test5/pouf");
	PATMATCH_TEST("/tmp/sandbox/*?[[:lower:]]?[[:digit:]]*/*?[[:lower:]]?[[:digit:]]*/**?**?**?**?**/", 0, "/tmp/sandbox/*?[[:lower:]]?[[:digit:]]*/*?[[:lower:]]?[[:digit:]]*/**?**?**?**?**/");
}
