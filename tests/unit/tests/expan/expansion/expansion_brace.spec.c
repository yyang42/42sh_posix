...
mt_expansion_brace_test(num01, "${}", g_null, g_null, "42sh: ${}: bad substitution", BRACE_ERROR, false)
...
mt_expansion_brace_test(num07, "${a`lol`}", g_null, g_null, "42sh: ${a`lol`}: bad substitution", BRACE_ERROR, false)
mt_expansion_brace_test(num08, "${@a}", g_null, g_null, "42sh: ${@a}: bad substitution", BRACE_ERROR, false)
mt_expansion_brace_test(num09, "${#abc}", "abc", g_null, g_null, BRACE_LENGTH, false)
mt_expansion_brace_test(num10, "${#12ab}", g_null, g_null, "42sh: ${#12ab}: bad substitution", BRACE_ERROR, false)
mt_expansion_brace_test(num11, "${12ab}", g_null, g_null, "42sh: ${12ab}: bad substitution", BRACE_ERROR, false)
mt_expansion_brace_test(num12, "${a:b}", "a", g_null, "42sh: ${a:b}: syntax error: operand expected", BRACE_ERROR, false)
...
mt_expansion_brace_test(num28, "${:+}", g_null, g_null, "42sh: ${:+}: bad substitution", BRACE_ERROR, false)
mt_expansion_brace_test(num29, "${@=pouet}", "@", g_null, "42sh: ${@=pouet}: cannot assign in this way", BRACE_ERROR, false)
mt_expansion_brace_test(num30, "${12:=lol}", "12", g_null, "42sh: ${12:=lol}: cannot assign in this way", BRACE_ERROR, false)
