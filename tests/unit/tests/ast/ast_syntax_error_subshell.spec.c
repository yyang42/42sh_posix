...
mt_test_ast_error(05, "()", "SyntaxError 1 : Syntax error near ')' : Empty simple command", false);
mt_test_ast_error(06, "123echo ( echo abc )", "SyntaxError 1 : Syntax error near '('", false);
mt_test_ast_error(07, "exit 42 ; ;", "SyntaxError 1 : Syntax error near ';' : Empty simple command", false);
