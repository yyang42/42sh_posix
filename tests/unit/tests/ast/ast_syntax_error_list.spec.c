...
mt_test_ast_error(06, ";;;", "SyntaxError 1:1 : Syntax error near ';;'", false);
mt_test_ast_error(07, "echo abc& ;", "SyntaxError 1:11 : Syntax error near ';' : Empty simple command", false);
mt_test_ast_error(08, ";;", "SyntaxError 1:1 : Syntax error near ';;'", false);
