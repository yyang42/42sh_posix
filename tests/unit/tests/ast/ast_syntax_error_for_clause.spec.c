...
mt_test_ast_error(01, "for",
	"SyntaxError 1:1 : Syntax error near 'for' : Missing 'NAME token'", false);
mt_test_ast_error(02, "echo abc; for 1234",
	"SyntaxError 1:11 : Syntax error near 'for' : invalid NAME token", false);
mt_test_ast_error(03, "echo abc; for hello",
	"SyntaxError 1:11 : Syntax error near 'for'", false);
