...
typedef void	(t_je_wait_fn)(int pid, int *res, void *ctx);
...
void				jobexec_fork_exec_interactive_job_sig_wrapper(t_job *job,
		void *ctx, void (exec_interactive_fn)(t_job *job, void *ctx));
