...
void							ast_until_clause_del(
									t_ast_until_clause *ast_until_clause);
void							ast_until_clause_del_void(void *this);

t_ast_until_clause				*ast_until_clause_new_from_tokens(
									t_lst *tokens, struct s_ast *ast);
void							*ast_until_clause_new_from_tokens_void(
									t_lst *tokens, struct s_ast *ast);
void							ast_until_clause_print_rec(
									t_ast_until_clause *ast_until_clause,
									int depth);
void							ast_until_clause_print_rec_void(
									void *ast_until_clause, int depth);
void							ast_until_clause_print_function(
									t_ast_until_clause *ast_until_clause,
									int depth);
void							ast_until_clause_print_function_void(
									void *ast_until_clause, int depth);
