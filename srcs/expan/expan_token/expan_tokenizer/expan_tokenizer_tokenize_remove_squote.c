...
t_expan_tokenizer_fn	g_expan_tokenizer_rule_remove_squote_fns[8] =
{
...
t_lst					*expan_tokenizer_tokenize_remove_squote(char *input)
{
	...
	index = 0;
	while (g_expan_tokenizer_rule_remove_squote_fns[index])
	{
		type = g_expan_tokenizer_rule_remove_squote_fns[index](this);
