...
static void			shenv_copy2(t_shenv *copy, t_shenv *this)
{
	...
	copy->shenv_read_buffer_db = twl_malloc_x0(sizeof(char *)
		* getdtablesize());
	...
	copy->shenv_is_input_from_stdin = false;
}
